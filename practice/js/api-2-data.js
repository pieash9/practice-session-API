...
function setImageById(id, value) {
  document.getElementById(id).src = value;
}

//car set 1
setImageById("image1", (data[0].imageURL));
setValueById('name1',data[0].name)
setValueById('details1',data[0].description)
setValueById('price1',data[0].price)
//car set 2
setImageById("image2", (data[1].imageURL));
setValueById('name2',data[1].name)
setValueById('details2',data[1].description)
setValueById('price2',data[1].price)